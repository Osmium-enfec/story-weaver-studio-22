...
export function ComposeCreateProjectCard({
  ...
  return (
    <div className="mb-8 rounded-lg border bg-card p-6">
      <h2 className="text-lg font-semibold">Start a new episode</h2>
      <p className="mt-1 text-sm text-muted-foreground">
        Name your episode and first part. Add scenes to the part, stitch them, then save the part.
        Start another part in the same episode anytime. Episodes created here stay outside a course until you add them to one.
      </p>
